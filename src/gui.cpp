...
namespace big
{
	...
	{
		// Modern color scheme
		static auto bgColor   = ImVec4(0.08f, 0.08f, 0.10f, 0.98f);
		static auto primary   = ImVec4(0.16f, 0.16f, 0.20f, 1.00f);
		static auto secondary = ImVec4(0.21f, 0.21f, 0.25f, 1.00f);
		static auto accent    = ImVec4(0.00f, 0.47f, 0.84f, 1.00f);
